...
public final class Constants {
  ...
  public static class WristConstants {
    ...
    public static final double LOW_WRIST_POS = 2.571;
    ...
    public static final double SAFE_POSITION = 1.569;
    ...
    public enum WristPositions { 
      ...
      MIDDLE_WRIST_POSITION(L2_POSITION,ALGAE_POSITION),
  ...
  public static class ElevatorConstants {
    ...
    public enum ElevatorHeights { 
      LOW_POSITION_L1(L1_HEIGHT,ALGAE_LOW_HEIGHT),
      LOW_MIDDLE_POSITION_L2(L2_HEIGHT,ALGAE_LOW_HEIGHT),
      HIGH_MIDDLE_POSITION_L3(L3_HEIGHT,ALGAE_LOW_HEIGHT),
      HIGH_POSITION_L4(L4_HEIGHT,ALGAE_HIGH_HEIGHT),
  ...
  public static class DriveConstants {
    ...
    public static final double FRONT_RIGHT_OFFSET = 0.25;
    public static final double BACK_LEFT_OFFSET = 3.08;
    public static final double BACK_RIGHT_OFFSET = 6.00;
